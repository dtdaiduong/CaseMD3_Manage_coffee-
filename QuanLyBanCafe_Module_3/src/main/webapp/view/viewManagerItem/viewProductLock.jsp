...
<head>
    ...
    <title>List products lock</title>
</head>
<body>
<div id="main">
    <div id="head">
    ...
    <div id="head-link">
        <div><label><h2>Products Lock</h2></label></div>
    </div>
    <div id="left">
    </div>
    <div id="content">
        <table class="table table-secondary table-hover">
            ...
            <tbody>
            <c:forEach items="${listProductLock}" var="product">
                <tr>
                    ...
                    <td style="text-align: center">
                        <a href="/servletController?action=unlock&idItem=${product.idItem}" type="button" class="btn btn-info">Unlock</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
